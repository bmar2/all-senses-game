...
All-Senses Game (generated by ChatGPT 5.1)

GitHub Pages website: https://bmar2.github.io/all-senses-game/

Single-file HTML Web page. It’s a ready-to-run interactive page that covers the five classic senses:
